...
CHOOSE_MENU() {
  ...
  if [[ -z $CUSTOMER_NAME ]]
    ...
    INSERT_CUSTOMER_RESULT=$($PSQL "INSERT INTO customers(phone,name) VALUES ('$CUSTOMER_PHONE','$FORMATTED_CUSTOMER_NAME') ")
  fi
  # get customer_id
  CUSTOMER_ID=$($PSQL "SELECT customer_id FROM customers WHERE phone = '$CUSTOMER_PHONE' ")
  #get time
  echo -e "\nWhat time would you like your $SERVICE_NAME_SELECTED, $FORMATTED_CUSTOMER_NAME?"
  read SERVICE_TIME
  ...
  echo -e "\nI have put you down for a $SERVICE_NAME_SELECTED at $SERVICE_TIME, $FORMATTED_CUSTOMER_NAME." 
